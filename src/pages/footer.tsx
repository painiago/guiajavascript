...
export function Footer (){
  return(
    <footer className={styles.footerContainer}>
      ...
      <div  className={styles.footerBackColor}>
      <div className={styles.footerPagamento}>
        <div className={styles.widthFooter}>
          <div className={styles.boxPagamento}>
            <div className={styles.boxAntSeguros}>
              <div>
                <h2>FORMAS DE PAGAMENTO</h2>
              </div>
              <div className={styles.imgPagamento}>
                <Image src={"/imagens/pagamentos.webp"} alt="formasdepagamento" width={400} height={400}/>
              </div>
            </div>
            <div className={styles.boxSeguro}>
              <div>
                <h2>SITE SEGURO</h2>
              </div>  
              <div className={styles.boxSeguro2}>
                <a>
        ...
        <div className={styles.footerContent}>
          <p>Copyright © 2023 - 2024 Guia JS | Todos os direitos reservados.</p>
